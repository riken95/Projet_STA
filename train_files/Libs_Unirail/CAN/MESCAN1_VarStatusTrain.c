...
|:---------:|:-----------:|:------:|:-------------------:|:--------:|:--------:|:--------:|:--------:|
| MOT_ERROR | MOT_WARNING | MOT_IO | MOT_STATE_DYNAMIQUE | MOT_VBAT | MOT_VBAT | MOT_VAR1 | MOT_VAR2 |
...
| :---: |:----:|:----:|:----:|:------------------------:|:----:|:-----------:|:--------------:|
|       |      |      |      | STOP_LOCO_XXX_CRASH_SOFT |      | MOT_SECU_PI | MOT_CRASH_SOFT |
...
|       bit7      |          bit6          |          bit5          |    bit4      | bit3  |       bit2      |         bit1         |        bit0       |
|:---------------:|:----------------------:|:----------------------:|:------------:|:-----:|:---------------:|:--------------------:|:-----------------:|
| MOT_CAN_BUS_OFF | MOT_CANTX_ERRORPASSIVE | MOT_CANRX_ERRORPASSIVE | MOT_BUG_SOFT |       | BATTERIE_FAIBLE | ELECTRIFICATION_RAIL | MOT_INIT_EN_COURS |
...
| bit7     |   bit6     |   bit5     |    bit4      |     bit3     |    bit2     |   bit1      |  bit0  |
|:--------:|:----------:|:----------:|:------------:|:------------:|:-----------:|:-----------:|:------:|
|          |            |   MOT_SW2  |    MOT_SW1   |  MOT_JUMPER4 | MOT_JUMPER3 | MOT_JUMPER2 |        |
...
| bit7 | bit6 | bit5 | bit4 |               bit3              |               bit2              |        bit1       | bit0 |
|:----:|:----:|:----:|:----:|:-------------------------------:|:-------------------------------:|:-----------------:|:----:|
|      |      |      |      | MOVE_SENS_LOCO_MANUEL_OR_REMOTE | MODE_MOVE_LOCO_MANUEL_OR_REMOTE | MOT_MODE_LOCO_OFF |      |
...
///////////////////////////////////////////////////////////////////////////////
//decomposition des datas de la trame mc_RP1_statusStart et mc_RP1_statusRun
///////////////////////////////////////////////////////////////////////////////
...
MC_Bit bdmc_modeRemoteControlMecanicien = {
    MC_ID_RP1_STATUS_RUN,
    RP1_STATE_DYNAMIQUE,
    RP1_MODE_REMOTE_CONTROL_MECANICIEN,
};

MC_Bit bdmc_moveSensMecanicien = {
    MC_ID_RP1_STATUS_RUN,
    RP1_STATE_DYNAMIQUE,
    RP1_MOVE_SENS_MECANICIEN,
};

MC_Bit bdmc_RP1_panicPowerOFF_loco = {
    MC_ID_RP1_STATUS_RUN,
    RP1_STATE_DYNAMIQUE,
    RP1_PANIC_POWER_OFF_LOCO,
};
...
// decomposition des datas de la trame mc_RP2_statusStart et mc_RP2_statusRun
// config de toutes les datas de la trame "mc_RP1_statusStart"
...
MC_Bit bdmc_RP2_panicPowerOFF_loco = {
    MC_ID_RP2_STATUS_RUN,
    RP2_STATE_DYNAMIQUE,
    RP2_PANIC_POWER_OFF_LOCO,
};
...
// \todo à valider
/*
Configuration « On Board » en cours de la locomotive
    bits[3..0] : Mode « ON board » en cours
    bits[5..4] : Niveau ERTMS en cours

 cdmc_vitesseModeMecanicien
 */
...
//decomposition des datas de la trame mc_BAL_statusStart et mc_BAL_statusRun

//config de toutes les datas de la trame "mc_BAL_statusRun"

// declaration de la trame "mc_BAL_statusStart" et datas associees
...
// declaration de la trame "mc_BAL_statusRun" et datas associees
...
MC_Bit bdmc_BAL_panicPowerOFF_loco = {
    MC_ID_BAL_STATUS_RUN,
    BAL_STATE_DYNAMIQUE,
    BAL_PANIC_POWER_OFF_LOCO,
};
...
// declaration de la trame "mc_LCD_statusRun"
...
MC_Bit bdmc_LCD_CAN_RxErrorPassive = {
    MC_ID_LCD_STATUS_RUN,
    LCD_WARNING,
...
//Union en 1 octet de tous les bits dynamiques
MC_Data8 cdmc_LCD_ACK_StatusStart = {
    MC_ID_LCD_STATUS_RUN,
    LCD_ACK_XXX_STATUS_START,
};
...
// declaration de la trame "mc_GSM_statusStart" et datas associees
...
// Declaration de la trame "mc_GSM_statusRun" et datas associees
...
MC_Bit bdmc_GSM_panicPowerOFF_loco = {
    MC_ID_GSM_STATUS_RUN,
    GSM_STATE_DYNAMIQUE,
    GSM_PANIC_POWER_OFF_LOCO,
};
