/**
  ...
  @Summary:
    This is the MESCAN1_VarStatusTrain.h file generated using PIC24 / dsPIC33 / PIC32MM MCUs
...
#ifndef MESCAN1_VAR_STATUS_TRAIN_H
#define	MESCAN1_VAR_STATUS_TRAIN_H
...
//Union en 1 octet de tous les bits
...
typedef enum {
    ...
    RP1_MODE_REMOTE_CONTROL_MECANICIEN = 4,
    RP1_MOVE_SENS_MECANICIEN = 5,
    RP1_PANIC_POWER_OFF_LOCO = 7,
...
extern MC_Bit bdmc_RP1_panicPowerOFF_loco;
//Union en 1 octet de tous les bits dynamiques
...
extern MC_Bit bdmc_RP2_panicPowerOFF_loco;
//Union en 1 octet de tous les bits dynamiques
...
typedef enum {
    BAL_PANIC_POWER_OFF_LOCO = 7,
} MC_BAL_STATUS_RUN_STATE_DYNAMIQUE_BIT;
...
extern MC_Bit bdmc_BAL_panicPowerOFF_loco;
...
///////////////////////////////////////////////////////////////////////////////
//Decomposition des datas de la trame mc_LCD_statusRun
///////////////////////////////////////////////////////////////////////////////
...
extern MC_Data8 cdmc_LCD_ACK_StatusStart;
...
///////////////////////////////////////////////////////////////////////////////
//Decomposition des datas de la trame mc_GSM_statusStart et mc_GSM_statusRun
///////////////////////////////////////////////////////////////////////////////
...
extern MC_Bit bdmc_GSM_panicPowerOFF_loco;
...
#endif	/*	MESCAN1_VAR_STATUS_TRAIN_H	*/